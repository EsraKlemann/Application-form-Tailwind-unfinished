<template>
  ...
  <section id="hero">
    ...
    <div class="container flex flex-col-reverse items-center px-6 mx-auto mt-10 space-y-0 md:space-y-0 md:flex-row">
      <!-- left item -->
      <div class="flex flex-col mb-32 space-y-1 md:w-1/2">
        <h1 class="max-w-md text-4xl font-bold text-center md:text-5xl md:text-left pt-16">
          Ontdek jouw deal
        </h1>
        <p class="max-w-sm text-center text-slate-600 md:text-left">
      ...
      <!-- image -->
      <div class="sm:w-auto w-1/2 mx-auto flex flex-shrink justify-end pl-30 sm:justify-end">
...
import FormOne from "../components/become-form/FormOne.vue";
import FormTwo from '@/components/become-form/FormTwo.vue';
